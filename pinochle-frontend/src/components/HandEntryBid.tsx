...
export const HandEntryBid: React.FC<HandEntryBidProps> = ({ bidEntryBoxProps, onSubmit }) => {
    console.log("Rendering HandEntryBid");
  ...
  return (
      <div className="flex flex-col items-center justify-center w-full px-6 py-3">
        ...
        <BidEntryBox {...bidEntryBoxProps} onSubmit={onSubmit} />
      </div>
  );
};
